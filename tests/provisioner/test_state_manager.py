import os
from provisioner.state_manager import StateManager, CLUSTER_STATUS
...
if __name__ == "__main__":
    ...
    slice1 = sm.create_cluster_record(
        slice_name="testslice001", aggregate_name="utah",
        hardware_type="m510", os_type="UBUNTU20-64-STD", node_count=1,
